...
const MyFavourites = (props) => {
    ...
    const renderTrialCard = ({ item, index }) => {
      const { name, full_name, rating, images, price, location, userlocation, status } = item;
